...
electoral votes in that file, so that they can be processed by PowerAlgo.java to determine the Banzhaf Actual Voting Power of Each State.
*/
...
public class Parse{
   ...
   return states; // return the states list with the Banzhaf Actual Voting Power of Each State filled in
   }
}
